          ...
          <div class="pull-right col-sm-5">
            <div class="signup-form">
              ...
              <form action="#;">
                ...
                <div class="form-group">
                  <small class="text-mute">By clicking Create Account, you agree to our Terms and confirm that you have
                    read our Data Policy, including our Cookie Use Policy. You may receive SMS message notifications from
                    Dostibook and can opt out at any time.</small>
                </div>
                <div class="form-group">
                  <input type="button" value="Sign up" class="btn btn-success input-lg" onclick="abc()">
